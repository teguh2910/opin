...
@section('page-title', 'Add BOM Entry')
                    ...
                    <form method="POST" action="{{ route('bom.store') }}">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-control @error('opin_id') is-invalid @enderror" id="opin_id" name="opin_id" required>
                                    ...
                                    @foreach($opins as $opin)
                                        <option value="{{ $opin->id }}" {{ old('opin_id') == $opin->id ? 'selected' : '' }}>
                            ...
                            <div class="col-md-6 mb-3">
                                <div id="cost-preview" class="card bg-light">
                                    <div class="card-body">
                                        ...
                                        <p class="mb-1">Unit Cost: <span id="unit-cost">Rp 0</span></p>
                                        <p class="mb-1">Quantity: <span id="preview-quantity">0</span></p>
                                        <p class="mb-0"><strong>Total Cost: <span id="total-cost">Rp 0</span></strong></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="d-flex justify-content-end">
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save me-2"></i>Create BOM Entry
                            </button>
                        </div>
                    </form>
                </div>
