                                    ...
                                    <div class="col-md-6">
                                        <table class="table table-borderless">
                                            <tr>
                                                ...
                                                <td>Rp
                                                    {{ number_format($opin->product_cost_without_common_cost, 0, ',', '.') }}
                                                </td>
                                            </tr>
                                            <tr>
                                                <td><strong>Gross Income:</strong></td>
                                                <td
                                                    class="{{ $opin->gross_income >= 0 ? 'text-success' : 'text-danger' }}">
                                                    Rp {{ number_format($opin->gross_income, 0, ',', '.') }}
                                                </td>
                                            </tr>
                                            <tr>
                                                <td><strong>SG&A
                                                        ({{ number_format($opin->sg_a_percentage * 100, 2, ',', '.') }}%):</strong>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td
                                                    class="{{ $opin->profit_percentage >= 0 ? 'text-success' : 'text-danger' }}">
                                            ...
                                            <div class="col-12 mb-3">
                                                <div class="card text-center">
                                                    <div class="card-body">
                                                        ...
                                                        <p class="card-text h4 text-danger">Rp
                                                            {{ number_format($opin->total_product_cost, 0, ',', '.') }}</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-12 mb-3">
                                                <div class="card text-center">
                                                    <div class="card-body">
                                                        ...
                                                        <p
                                                            class="card-text h4 {{ $opin->gross_income >= 0 ? 'text-success' : 'text-danger' }}">
                                                            Rp {{ number_format($opin->gross_income, 0, ',', '.') }}</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="card text-center">
                                                    <div class="card-body">
                                                        ...
                                                        <p
                                                            class="card-text h4 {{ $opin->profit_percentage >= 0 ? 'text-success' : 'text-danger' }}">
                                                            {{ number_format($opin->profit_percentage, 2, ',', '.') }}%</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
