                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control @error('part_no') is-invalid @enderror"
                                        id="part_no" name="part_no" value="{{ old('part_no', $opin->part_no) }}" required>
                                    @error('part_no')
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control @error('part_name') is-invalid @enderror"
                                        id="part_name" name="part_name" value="{{ old('part_name', $opin->part_name) }}"
                                        required>
                                    @error('part_name')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" step="0.01"
                                        ...
                                        name="sales_price" value="{{ old('sales_price', $opin->sales_price) }}" required>
                                    @error('sales_price')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" step="0.01"
                                        ...
                                        name="labor_cost" value="{{ old('labor_cost', $opin->labor_cost) }}" required>
                                    @error('labor_cost')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" step="0.01"
                                        ...
                                        name="machine_cost" value="{{ old('machine_cost', $opin->machine_cost) }}"
                                        required>
                                    @error('machine_cost')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" step="0.01"
                                        ...
                                        id="current_machine" name="current_machine"
                                        value="{{ old('current_machine', $opin->current_machine) }}" required>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" step="0.01"
                                        ...
                                        name="other_fixed" value="{{ old('other_fixed', $opin->other_fixed) }}" required>
                                    @error('other_fixed')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" step="0.01"
                                        ...
                                        name="defect_cost" value="{{ old('defect_cost', $opin->defect_cost) }}" required>
                                    @error('defect_cost')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" step="0.01" min="0" max="100"
                                        ...
                                        value="{{ old('sg_a_percentage', number_format($opin->sg_a_percentage * 100, 2, '.', '')) }}"
                                        required>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" step="0.01" min="0"
                                        ...
                                        value="{{ old('manual_total_product_cost', $opin->manual_total_product_cost) }}">
                                    <small class="form-text text-muted">Leave empty to use calculated value. Current
                                        calculated: Rp
